...
class TestKG_RAG_KnowledgeGraphRAGRetriever:
    def test_retriever(self):
        ...
        retriever.retrieve("What Canadian organizations can help with Duchenne Muscular Dystrophy?")
        retriever.retrieve("What is the incidence rate of Duchenne Muscular Dystrophy?")
        retriever.retrieve("Give me a list of Canadian PKU organizations")
        retriever.retrieve("What is the prevalence of Duchenne Muscular Dystrophy in the UK?")
        retriever.retrieve("What genes are associated with Duchenne Muscular Dystrophy?")
